...
-- ============================================================
-- supabase/migrations/20260630120000_profiles.sql
-- ============================================================
-- Perfiles (nickname + avatar) 1:1 con auth.users. RLS own-only (los miembros del
-- equipo salen del RPC list_team_members SECURITY DEFINER; la presencia la
-- broadcastea cada cliente con su propio nick). Definido acá (antes del RPC que
-- lo joinea).
...
-- Auto-provisión del profile al alta (patrón Supabase) + backfill de existentes.
...
-- ===========================================================================
-- Links view-only públicos de documentos (Notion "Share to web") — 20260701230640
-- ===========================================================================
...
-- Resolutores públicos (anon, pre-auth). SECURITY DEFINER: leen documents sin RLS
-- pero solo exponen el set compartido. WARN del linter intencional (ver migración).
...
-- ============================================================
-- supabase/migrations/20260713120000_document_versions.sql
-- ============================================================
...
-- ============================================================
-- supabase/migrations/20260915120000_team_calendar.sql
-- ============================================================
...
-- ============================================================
-- supabase/migrations/20260916120000_doc_images.sql
-- ============================================================
